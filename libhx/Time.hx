module Time
(Var "addToClockTime",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "calendarTimeToString",Value {args = 1, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "diffClockTimes",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "formatCalendarTime",Value {args = 3, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "getClockTime",Value {args = 0, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "toCalendarTime",Value {args = 1, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "toClockTime",Value {args = 1, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "toUTCTime",Value {args = 1, fixity = Def, priority = 9, letBound = True, traced = False})
