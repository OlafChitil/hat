...
(Method "Ix" "inRange",Value {args = -1, fixity = Def, priority = 9, letBound = True, traced = True})
(Method "Ix" "index",Value {args = -1, fixity = Def, priority = 9, letBound = True, traced = True})
(Method "Ix" "range",Value {args = -1, fixity = Def, priority = 9, letBound = True, traced = True})
(Method "Ix" "rangeSize",Value {args = -1, fixity = Def, priority = 9, letBound = True, traced = True})
(TypeClass "Array",TyCls (Ty ["MkArray"] []))
