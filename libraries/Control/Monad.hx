...
(Var "<=<",Value {args = 0, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "=<<",Value {args = 2, fixity = R, priority = 1, letBound = True, traced = False})
(Var ">=>",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
...
(Var "foldM_",Value {args = 3, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "forM",Value {args = 0, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "forM_",Value {args = 0, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "forever",Value {args = 1, fixity = Def, priority = 9, letBound = True, traced = False})
...
(Var "replicateM",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "replicateM_",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
...
(Var "void",Value {args = 0, fixity = Def, priority = 9, letBound = True, traced = False})
...
(TypeClass "MonadPlus",TyCls (Cls ["mplus","mzero"]))
