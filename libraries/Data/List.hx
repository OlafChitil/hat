...
(Var "intercalate",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
...
(Var "isInfixOf",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
...
(Var "permutations",Value {args = 1, fixity = Def, priority = 9, letBound = True, traced = False})
...
(Var "stripPrefix",Value {args = 2, fixity = Def, priority = 9, letBound = True, traced = False})
(Var "subsequences",Value {args = 1, fixity = Def, priority = 9, letBound = True, traced = False})
